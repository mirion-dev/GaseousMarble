...
| -- | -- | -- |
| `gm_font(font_name, sprite_path)` | Add a font generated by `tools/generate_font.py`. | `1` - Font already exists<br>`0` - OK<br>`-1` - Failed to open file<br>`-2` - Invalid header<br>`-3` - Data corrupted<br>`-4` - Failed to load sprite<br>`-100` - Invalid argument |
...
| -- | -- | -- |
| `gm_set_font(font_name)` | `gm_get_font()` | **Setter**<br>`0` - OK<br>`-1` - Font not found<br>**Getter**<br>`!= ""` - OK<br>`""` - Font unspecified<br> |
