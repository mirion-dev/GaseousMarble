...
generate_font('simsun.ttf', '../test.gm82/gm_fonts/font_default.png', font_size=18, charset=charset, stroke_width=1)

shutil.copytree('../test.gm82/gm_fonts', '../example.gm82/gm_fonts', dirs_exist_ok=True)
